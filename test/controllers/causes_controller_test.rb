...
class CausesControllerTest < ActionController::TestCase
  ...
  test "should create cause" do
    assert_difference('Cause.count') do
      post :create, cause: { cid_id: @cause.cid_id, disease: @cause.disease, research_id: @cause.research_id }
    end
  ...
  test "should update cause" do
    patch :update, id: @cause, cause: { cid_id: @cause.cid_id, disease: @cause.disease, research_id: @cause.research_id }
    assert_redirected_to cause_path(assigns(:cause))
  end
